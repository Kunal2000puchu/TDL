...
$sql = "DELETE FROM TDL_details WHERE t_id='".$_POST["t_id"]."'";
$conn->query($sql);
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-6918"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="skrollable u-align-center u-clearfix u-image u-section-1" id="carousel_c246" data-image-width="1280" data-image-height="477">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-custom-font u-font-merriweather u-text u-text-body-alt-color u-text-1">Delete TDL</h1>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-group u-form-name">
              <label for="name-6f84" class="u-label">TDL ID</label>
              <input type="text" placeholder="Enter TDL ID To be Deleted" id="name-6f84" name="t_id" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
